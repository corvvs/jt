...
export const Main = (props: {
  ...
  const { isOpen: isEditJsonModalOpen } = useEditJsonModal();
  ...
  }, [filteringPreference.showPanel, setFilteringBooleanPreference, isEditJsonModalOpen, preformattedValueModalState.isOpen]);
